...
# Detect latest Windows Server 2022 Datacenter (non-core) image
echo -e "${CYAN}🔍 Finding latest Windows Server 2022 Datacenter image...${NC}"
...
if [[ -z "$LATEST_IMAGE" ]]; then
  echo -e "${RED}✖ Could not fetch latest 2022 image. Using fallback: windows-server-2022-dc-v20250514${NC}"
